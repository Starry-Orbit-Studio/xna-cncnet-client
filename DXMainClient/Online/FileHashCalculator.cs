...
namespace DTAClient.Online
{
    public class FileHashCalculator
    {
        ...
        public void CalculateHashes()
        {
            ...
            List<DirectoryInfo> iniPaths = [SafePath.GetDirectory(ClientConfiguration.Instance.ConfigFileDirectory, "Game Options")];

            if (ClientConfiguration.Instance.ClientGameType != ClientType.YR)
                iniPaths.Add(SafePath.GetDirectory(ClientConfiguration.Instance.ConfigFileDirectory, "Map Code"));
