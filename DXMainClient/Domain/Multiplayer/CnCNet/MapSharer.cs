...
namespace DTAClient.Domain.Multiplayer.CnCNet
{
    ...
    public static class MapSharer
    {
        ...
        private static string MapUpload(string _URL, Map map, string gameName, out bool success)
        {
            ...
            FileInfo zipFile = SafePath.GetFile(ProgramConstants.GamePath, ClientConfiguration.Instance.CustomMapsDirectory , FormattableString.Invariant($"{map.SHA1}.zip"));
        ...
        {
            string customMapsDirectory = SafePath.CombineDirectoryPath(ProgramConstants.GamePath, ClientConfiguration.Instance.CustomMapsDirectory);
