    ...
    public abstract class MultiplayerGameLobby : GameLobbyBase, ISwitchable
    {
        ...
        public override void Initialize()
        {
            ...
            for (int i = 0; i < MAX_PLAYER_COUNT; i++)
            {
                ...
                AddSideToDropDown(ddPlayerSides[i], spectatorName, spectatorName.L10N("Client:Sides:SpectatorSide"),
        ...
        {
            Map map = MapLoader.LoadCustomMap(SafePath.CombineFilePath(ClientConfiguration.Instance.CustomMapsDirectory, mapName), out string resultMessage);
            if (map != null)
            {
